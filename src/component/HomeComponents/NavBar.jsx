...
//   useEffect(() => {
//     const handleScroll = () => {
//       // Sets scrolled true if user has scrolled more than 50px
...
//       // Check if the click is outside the menu and the hamburger icon button
...
//   const logoText = "Fluxion Studio"; // Aligned with the Home component

//   return (
//     <nav
//       className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
//         scrolled ? "bg-white shadow-xl backdrop-blur-sm bg-opacity-95" : "bg-transparent backdrop-blur-sm" // Modern blurred effect on scroll
//       }`}
//     >
...
//             scrolled ? "text-indigo-700" : "text-indigo-600"
//           }`}
//         >
//           {logoText}
//         </Link>
...
//               <Link
//                 to={link.path}
//                 className={`text-lg relative py-1 transition-all duration-200 ${
...
//         {/* Desktop CTA Button (added) */}
//         <div className="hidden md:flex">
//           <Link to="/contact">
//             <button
//               className="ml-6 px-6 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition duration-300"
//             >
//               Start Project
//             </button>
//           </Link>
...
//             className="text-gray-800 p-2 rounded-lg hover:bg-gray-100 transition"
...
//       <div
//         ref={menuRef}
//         className={`fixed top-0 right-0 h-screen w-72 bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-40 ${
...
//           <ul className="flex flex-col items-start space-y-6 text-lg font-semibold text-gray-800 mt-10">
//             {links.map((link) => (
